...
- `MR_TITLE` Merge Request title. Default: `chore: update module refs`.
...
**Note**: `MR_BRANCH` is generated dynamically using `CI_COMMIT_REF_SLUG` and `CI_PIPELINE_ID` to avoid conflicts.
...
variables:
  ...
  MR_TITLE: "chore: update module refs"
...
update:
  ...
  script:
    ...
    - |
      ...
      MR_TITLE="chore: update module refs (${CI_COMMIT_REF_NAME})"
      export MR_BRANCH
      export MR_TITLE
    - |
      TOKEN_ARG=""
